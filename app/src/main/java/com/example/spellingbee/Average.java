...
public class Average extends AppCompatActivity {
    ...
    String quizData[][]={
            ...
            {"NOUN; a type of animal that has several pairs of legs and a body made up of sections that are covered in a hard outer shell" , "Crustacean" , "crustatian" , "crustacian" , "chrustacean"},
            {"NOUN; a type of roll that has a curved shape and that is usually eaten at breakfast" , "croissant" , "crosant" , "crossant" , "croisant"},
            {"NOUN; the state of having identical cumulative distribution function or values" , "homogeneity" , "homogenity" , "homogeniety" , "homogineity"},
            {"ADJ; linked together" , "concatenate" , "concatinate" , "concatennate" , "concatinnate"},
            {"NOUN; an official empowered to act for a higher official" , "lieutenant" , "leutenant" , "liutenant" , "luetenant"},
            {"NOUN; a person who writes plays" , "playwright" , "playwrite" , "playright" , "playrite"},
            {"NOUN; an abnormal state in which you become unconscious and your body moves in an uncontrolled and violent way" , "seizure" , "seizzure" , "siezure" , "siezzure"},
            {"NOUN; a forward or backward movement of your body on the ground or in the air that is made by bringing your feet over head" , "somersault" , "sommersalt" , "sommersault" , "somersalt"},
            {"NOUN; an athletic contest that is a long distance race consistinig of three phases" , "triathlon" , "thriathlon" , "thriathlone" , "triathlone"},
            {"ADJ; made up or done without special preparation" , "extemporaneous" , "extemporaneus" , "extemporanuse" , "extemporanuous"},
