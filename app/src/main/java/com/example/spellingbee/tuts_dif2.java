...
public class tuts_dif2 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tuts_dif2);

        final Button startAve =(Button)findViewById(R.id.startBtn);
        startAve.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent playIntent = new Intent(tuts_dif2.this,Difficult.class);
    ...
    public boolean onTouchEvent(MotionEvent touchevent){
        switch (touchevent.getAction()){
            ...
            case MotionEvent.ACTION_UP:
                ...
                y2 = touchevent.getY();
                if(x1 < x2){
                    Intent i = new Intent(tuts_dif2.this, tuts_dif1.class);
                    startActivity(i);
                }
                break;
